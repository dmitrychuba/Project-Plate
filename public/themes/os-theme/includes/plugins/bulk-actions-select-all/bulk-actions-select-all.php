...
define('BASA_PLUGIN_DIR', rtrim(dirname(__FILE__), '\/') . DIRECTORY_SEPARATOR);
define('BASA_PLUGIN_URL', get_bloginfo('template_url') . '/' . trim(str_ireplace(get_template_directory(), '', dirname(__FILE__)), '/') . '/');
